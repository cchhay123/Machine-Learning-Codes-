...
accu(test$price_30_days_out, predictions1)
...
g_rf <- ggplot(res_db, aes(y = trees, x = nodesize, fill = oob_accuracy)) + # set aesthetics
...
accuracy(rf_preds, test$price_30_days_out)
